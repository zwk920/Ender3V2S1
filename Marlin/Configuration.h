...
#define EXTRUDE_MINTEMP 181  // MRiscoC Customizable by menu
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.5, -7, -1.5 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define Z_MIN_POS 0
#define X_MAX_POS 240  // MRiscoC Stock physical limit
...
#define FILAMENT_RUNOUT_SENSOR // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 2  // MRiscoC Customizable by menu
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_BED_SIZE ), (Y_MAX_POS - 10), 20 }
